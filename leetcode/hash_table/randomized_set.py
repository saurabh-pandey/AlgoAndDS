#URL: https://leetcode.com/explore/learn/card/hash-table/187/conclusion-hash-table/1141/
#Description
"""
...
class RandomizedSet:
    ...
    def getRandom(self) -> int:
        rand_indx = random.randint(0, len(self.nums) - 1)
        return self.nums[rand_indx]
