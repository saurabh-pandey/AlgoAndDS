#URL: https://leetcode.com/explore/learn/card/n-ary-tree/131/recursion/919/
#Description
"""
...
def maxDepthTopDown(node, depth, max_depth):
  if node is None:
    return max_depth
  max_depth = depth if depth > max_depth else max_depth
  for child in node.children:
    if child is not None:
      max_depth = maxDepthTopDown(child, depth + 1, max_depth)
  return max_depth



def maxDepth(root):
  return maxDepthTopDown(root, 1, 0)